...
namespace mp4box
{
    ...
    public class NativeMethods
    {
        ...
        /// <para>https://msdn.microsoft.com/en-us/library/windows/desktop/ms686203(v=vs.85).aspx</para>
        /// </summary>
        /// <param name="lpPathName">The directory to be added to the search path.
